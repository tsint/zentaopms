...
$rows = array(
    ...
    array('task', 102, ',1,2,', 11, 111, 'admin', '2026-07-02', 3),
...
r($report->getGlobalEffortDistributionTest('product', $filters)) && p() && e('2:3:16,1:4:14,3:1:8');            // 按产品分布
