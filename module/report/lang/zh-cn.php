...
$lang->report->globalEffort->health            = '团队健康';
$lang->report->globalEffort->costProgress      = '成本与进度';
$lang->report->globalEffort->distribution      = '工时分布';
$lang->report->globalEffort->records           = '工时明细';
$lang->report->globalEffort->spaceFilter       = '空间维度';
$lang->report->globalEffort->timeFilter        = '时间维度';
$lang->report->globalEffort->peopleFilter      = '人员维度';
$lang->report->globalEffort->detailFilters     = '明细过滤';
$lang->report->globalEffort->management        = '整体分析';
$lang->report->globalEffort->objectDistribution= '研发对象分布比';
$lang->report->globalEffort->staleObjects      = '停滞对象';
$lang->report->globalEffort->accountStack      = '人员工时分布';
$lang->report->globalEffort->totalConsumed     = '总消耗工时';
$lang->report->globalEffort->estimatedRatio    = '总消耗/预估工时';
$lang->report->globalEffort->estimatedConsumed = '实际消耗';
$lang->report->globalEffort->estimatedTotal    = '预估总工时';
$lang->report->globalEffort->begin             = '开始日期';
$lang->report->globalEffort->end               = '结束日期';
$lang->report->globalEffort->dateRange         = '动态时间';
$lang->report->globalEffort->customDate        = '自定义时间';
$lang->report->globalEffort->productLine       = '产品线';
$lang->report->globalEffort->program           = '项目集';
$lang->report->globalEffort->objectID          = '对象ID';
$lang->report->globalEffort->includeRelated    = '包含关联任务';
$lang->report->globalEffort->staleDays         = '停滞天数';
$lang->report->globalEffort->dept              = '部门';
$lang->report->globalEffort->team              = '团队';
$lang->report->globalEffort->member            = '成员';
$lang->report->globalEffort->detailDate        = '具体日期';
$lang->report->globalEffort->detailAccount     = '具体人员';
$lang->report->globalEffort->detailProduct     = '具体产品';
$lang->report->globalEffort->detailProject     = '具体项目';
$lang->report->globalEffort->workContent       = '工作内容';
$lang->report->globalEffort->objectType        = '对象类型';
$lang->report->globalEffort->recordCount       = '记录数';
$lang->report->globalEffort->consumed          = '已消耗';
$lang->report->globalEffort->left              = '剩余';
$lang->report->globalEffort->progress          = '进度';
$lang->report->globalEffort->risk              = '风险';
$lang->report->globalEffort->scope             = '范围';
$lang->report->globalEffort->objects           = '对象数';
$lang->report->globalEffort->overrunObjects    = '超支对象';
$lang->report->globalEffort->activeUsers       = '活跃人员';
$lang->report->globalEffort->activeDays        = '活跃天数';
$lang->report->globalEffort->avgHoursPerUser   = '人均工时';
$lang->report->globalEffort->avgHoursPerDay    = '日均工时';
$lang->report->globalEffort->overloadDays      = '超负荷天数';
$lang->report->globalEffort->topAccount        = '最高投入人员';
$lang->report->globalEffort->topAccountShare   = '投入占比';
$lang->report->globalEffort->productCount      = $lang->productCommon . '数';
$lang->report->globalEffort->projectCount      = $lang->projectCommon . '数';
$lang->report->globalEffort->taskCount         = '任务数';
$lang->report->globalEffort->requirementCount  = '需求数';
$lang->report->globalEffort->exportCSV         = '导出 CSV';
$lang->report->globalEffort->filter            = '筛选';
$lang->report->globalEffort->empty             = '暂无工时数据';
$lang->report->globalEffort->notEstimated      = '暂无预估';

$lang->report->globalEffort->dateRangeList['all']     = $lang->all;
$lang->report->globalEffort->dateRangeList['week']    = '本周';
$lang->report->globalEffort->dateRangeList['month']   = '本月';
$lang->report->globalEffort->dateRangeList['quarter'] = '本季度';
$lang->report->globalEffort->dateRangeList['custom']  = '自定义';

$lang->report->globalEffort->objectTypeList['']            = $lang->all;
$lang->report->globalEffort->objectTypeList['epic']        = '业务需求';
$lang->report->globalEffort->objectTypeList['requirement'] = '用户需求';
$lang->report->globalEffort->objectTypeList['story']       = '研发需求';
$lang->report->globalEffort->objectTypeList['bug']         = 'Bug';
$lang->report->globalEffort->objectTypeList['task']        = '任务';
$lang->report->globalEffort->objectTypeList['other']       = '其他';

$lang->report->globalEffort->objectTypeColors['epic']        = '#7c3aed';
$lang->report->globalEffort->objectTypeColors['requirement'] = '#d97706';
$lang->report->globalEffort->objectTypeColors['story']       = '#059669';
$lang->report->globalEffort->objectTypeColors['bug']         = '#dc2626';
$lang->report->globalEffort->objectTypeColors['task']        = '#2563eb';
$lang->report->globalEffort->objectTypeColors['other']       = '#6b7280';

$lang->report->globalEffort->riskList['low']    = '低';
$lang->report->globalEffort->riskList['medium'] = '中';
$lang->report->globalEffort->riskList['high']   = '高';
