...
$lang->workflowflowchart->transitionName = 'Transition name, e.g. Skip / Duplicate / Invalid';
$lang->workflowflowchart->addNode        = 'Add State Node';
$lang->workflowflowchart->deleteNode     = 'Delete State Node';
$lang->workflowflowchart->setAsEntry     = 'Set as Entry';
$lang->workflowflowchart->unsetEntry     = 'Unset Entry';
$lang->workflowflowchart->entryNodeTitle = 'Entry node: objects enter the flowchart from this state when created';
$lang->workflowflowchart->nodeID         = 'State key, e.g. accepted';
$lang->workflowflowchart->nodeLabel      = 'Display name';
...
$lang->workflowflowchart->error->invalidNewNode      = 'The state key must start with a lowercase letter and contain only lowercase letters, numbers, or underscores. The display name is required.';
$lang->workflowflowchart->error->deleteEntryNode     = 'The initial state node cannot be deleted.';
$lang->workflowflowchart->error->missingEntryState   = 'The flow must include the state assigned when the object is created.';
$lang->workflowflowchart->error->invalidEntries      = 'The entry state list is invalid.';
