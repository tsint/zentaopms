...
- 列表 Hook 支持 dtable 单元格和异步渲染 @1
- 需求和 Bug 编辑页仅保留弹窗入口，且 Bug 核心编辑表单未加入工时字段 @1
- 我的地盘三类列表均可直接登记工时 @1
- 批量录入 UI 默认 3 行、最多 10 行，left 非必填 @1
- 任务登记工时支持最多 10 行 @1
- 管理员编辑任务时预计工时不因团队或父任务被只读 @1
- 登记工时弹窗已有工时列表使用 Zin 组件渲染而非拼接 HTML 字符串 @1
- Bug 创建表单包含工时预计字段 @1
- Bug 创建初始工时登记与 Bug 创建原子化，estimate=0 时不写工时记录 @1
- 详情工时按钮仅由核心动作渲染，不再由 Hook 重复注入 @1
- 对象和任务工时按 10 条分页，工作内容安全输出且弹窗内不重复标题 @1
*/
