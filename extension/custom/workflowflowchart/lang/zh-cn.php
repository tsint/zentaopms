...
$lang->workflowflowchart->transitionName = '流转名称，如 不做 / 重复 / 无效';
$lang->workflowflowchart->addNode        = '添加状态节点';
$lang->workflowflowchart->deleteNode     = '删除状态节点';
$lang->workflowflowchart->setAsEntry     = '设为初始节点';
$lang->workflowflowchart->unsetEntry     = '取消初始节点';
$lang->workflowflowchart->entryNodeTitle = '初始节点：对象创建时从此状态进入流程图';
$lang->workflowflowchart->nodeID         = '状态键，如 accepted';
$lang->workflowflowchart->nodeLabel      = '显示名称';
...
$lang->workflowflowchart->error->invalidNewNode      = '状态键须以小写字母开头，仅包含小写字母、数字或下划线，且显示名称不能为空。';
$lang->workflowflowchart->error->deleteEntryNode     = '对象的初始状态节点不能删除。';
$lang->workflowflowchart->error->missingEntryState   = '流程必须包含对象创建时的初始状态节点。';
$lang->workflowflowchart->error->invalidEntries      = '初始状态节点列表无效。';
