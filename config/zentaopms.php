...
define('TABLE_GITLABUSER',   '`' . $config->db->prefix . 'gitlabuser`');
...
define('TABLE_WEEKREPORT', '`' . $config->db->prefix . 'weekreport`');
...
$config->objectTables['weekreport']     = TABLE_WEEKREPORT;
...
$config->objectTables['gitlabuser']     = TABLE_GITLABUSER;
